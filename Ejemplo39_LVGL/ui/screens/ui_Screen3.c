...
void ui_Screen3_screen_init(void)
{
    ...
    ui_Chart1_series_1 = lv_chart_add_series(ui_Chart1, lv_color_hex(0x6705FF),
...
void chart_refresh(int16_t adc){


	lv_chart_set_next_value(ui_Chart1, ui_Chart1_series_1, adc);
