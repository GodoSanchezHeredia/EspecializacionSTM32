...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LED1_Pin|LED2_Pin|RELE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_Pin LED2_Pin RELE_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|RELE_Pin;
